...
public class RoleCheckAop {
    ...
    @Pointcut("execution(* com.sparta.lv4_endrmseha.service.PostService.updatePost(..))")
    private void updatePost() {}

    @Pointcut("execution(* com.sparta.lv4_endrmseha.service.PostService.deletePost(..))")
    private void deletePost() {}

    @Pointcut("execution(* com.sparta.lv4_endrmseha.service.CommentService.updateComment(..))")
    private void updateComment() {}

    @Pointcut("execution(* com.sparta.lv4_endrmseha.service.CommentService.deleteComment(..))")
